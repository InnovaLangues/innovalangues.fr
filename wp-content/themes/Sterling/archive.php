...
<section id="content-container" class="clearfix">
    <div id="main-wrap" class="clearfix">
        <div class="page_content">
            ...
            <p class="archive-heading"><?php _e( '', '' ); single_cat_title(); ?></p>

            <?php /* If this is a tag archive */ } elseif ( is_tag() ) { ?>
            <p class="archive-heading"><?php _e( 'Posts Tagged ', 'tt_theme_framework' ); single_tag_title(); ?></p>

            <?php /* If this is a daily archive */ } elseif ( is_day() ) { ?>
            <p class="archive-heading"><?php _e( 'A', 'tt_theme_framework' ); the_time( 'F jS, Y' ); ?></p>

            <?php /* If this is a monthly archive */ } elseif ( is_month() ) { ?>
            <p class="archive-heading"><?php _e( '', 'tt_theme_framework' ); the_time( 'F, Y' ); ?></p>

            <?php /* If this is a yearly archive */ } elseif ( is_year() ) { ?>
            <p class="archive-heading"><?php _e( '','tt_theme_framework' ); the_time( 'Y' ); ?></p>
                            ...
                            <?php
                                if ( 'true' == $posted_by ) { ?>
                                    <span class="metadata postinfo">
                                        <?php _e( 'Posted by ', 'tt_theme_framework' ); the_author_posts_link(); _e( ' on ', 'tt_theme_framework' ); the_time( get_option( 'date_format' ) ); ?>
                                    </span>
                            <?php }
