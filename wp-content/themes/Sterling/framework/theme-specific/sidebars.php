...
/* sidebar aggiuntive */ 
register_sidebar( array(
	'name' => __( 'Realisations', 'tt_theme_framework' ),
	'description' => __( 'This sidebar is displayed in the realisations page.', 'tt_theme_framework' ),
	'before_widget' => '<div class="sidebar-widget %2$s">',
	'after_widget' => '</div>',
	'before_title' => '<p class="widget-heading">',
	'after_title' => '</p>',
...
register_sidebar( array(
	'name' => __( 'Organisations', 'tt_theme_framework' ),
	'description' => __( 'This sidebar is displayed in the organisations page.', 'tt_theme_framework' ),
	'before_widget' => '<div class="sidebar-widget %2$s">',
	'after_widget' => '</div>',
	'before_title' => '<p class="widget-heading">',
	'after_title' => '</p>',
...
register_sidebar( array(
	'name' => __( 'Partenariat', 'tt_theme_framework' ),
	'description' => __( 'This sidebar is displayed in the partenariat page.', 'tt_theme_framework' ),
	'before_widget' => '<div class="sidebar-widget %2$s">',
	'after_widget' => '</div>',
	'before_title' => '<p class="widget-heading">',
	'after_title' => '</p>',
...
register_sidebar( array(
	'name' => __( 'Evenements', 'tt_theme_framework' ),
	'description' => __( 'This sidebar is displayed in the evenements page.', 'tt_theme_framework' ),
	'before_widget' => '<div class="sidebar-widget %2$s">',
	'after_widget' => '</div>',
	'before_title' => '<p class="widget-heading">',
	'after_title' => '</p>',
...
register_sidebar( array(
	'name' => __( 'Contact', 'tt_theme_framework' ),
	'description' => __( 'This sidebar is displayed in the contact page.', 'tt_theme_framework' ),
	'before_widget' => '<div class="sidebar-widget %2$s">',
	'after_widget' => '</div>',
	'before_title' => '<p class="widget-heading">',
	'after_title' => '</p>',
