...
$options[] = array( "name" => __('Default Avatar','tt_theme_framework'),
			"desc" => __("By default, our theme uses our custom avatar when your comment user does not have a gravatar account. <em>Un-check this box to enable theme to use WordPress default avatars. </em>","tt_theme_framework"),
